-- ChatKit Security & Monitoring Tables Migration
...
DROP POLICY IF EXISTS "Service role full access to usage metrics" ON chat_usage_metrics;
DROP POLICY IF EXISTS "Service role full access to security events" ON chat_security_events;
DROP POLICY IF EXISTS "Authenticated users read usage metrics" ON chat_usage_metrics;
DROP POLICY IF EXISTS "Authenticated users read security events" ON chat_security_events;
...
-- ============================================
-- 8. Scheduled View Refresh (using pg_cron)
-- ============================================
