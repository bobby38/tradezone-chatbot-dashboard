...
export class SettingsManager {
  ...
  static async saveAllSettings(settings: SettingsData): Promise<boolean> {
    try {
      console.log("[SettingsManager] Saving all settings to database...", {
      ...
      if (!response.ok) {
        ...
        console.error("[SettingsManager] Save failed:", {
      ...
      console.log("[SettingsManager] Save successful:", result);
      ...
      console.error("[SettingsManager] Error saving all settings:", error);
  ...
  static async migrateFromLocalStorage(): Promise<void> {
    ...
    console.log(
      "Migration temporarily disabled to prevent recursive config nesting",
    );
