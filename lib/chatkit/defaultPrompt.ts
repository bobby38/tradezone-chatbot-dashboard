...
11. Photos are optional and NOT required. Most customers visit store for inspection. DO NOT ask for photos. If customer voluntarily uploads, acknowledge briefly ("Thanks!"). Skip photos entirely—proceed directly to submission once contact + device details collected.
