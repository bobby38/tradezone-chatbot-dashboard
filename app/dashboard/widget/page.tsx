  ...
  const resetToDefaults = () => {
    if (confirm("Reset to default settings?")) {
      setConfig({
        ...
        placeholder: "Ask about products, prices, trade-ins...",
        videoUrl:
          "https://videostream44.b-cdn.net/tradezone-welcome-avatar-2.mp4",
        enableVoice: true,
        enableVideo: true,
        customCSS: "",
      });
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setConfig({ ...config, autoOpen: checked })
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setConfig({ ...config, enableVideo: checked })
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setConfig({ ...config, subGreeting: e.target.value })
                      }
                    />
                  </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                ...
                <p className="text-xs text-muted-foreground">
                  Add to <code>functions.php</code> or use the “Insert Headers
                  and Footers” plugin
                </p>
              </div>
            </CardContent>
