...
const TEST_QUERIES = [
  {
    ...
    description:
      "Cheap phone search should show real phones, not hallucinated products or internal instructions",
  },
  {
  ...
  },
  {
    ...
    description:
      "Galaxy Tab search should prioritize tablets over phones or games",
  },
  {
    query: "poster",
    shouldContain: [],
    ...
    description:
      "Poster search should not hallucinate products that don't exist (404s)",
  },
];
